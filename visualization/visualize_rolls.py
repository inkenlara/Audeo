...
GT_DIR = SCRIPT_DIR.parent / "data_provided" / "midi" / "testing"
EST_DIR = SCRIPT_DIR.parent / "data" / "estimate_Roll" / "testing"
OUTPUT_DIR = SCRIPT_DIR.parent / "data" / "generated" / "rolls"
